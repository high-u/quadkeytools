 ...
 */
export const sibling = function( quadkey, direction ) {
	direction = {
		'left' : Direction.Left,
 ...
 */
export const locationToPixel = function( coord, detail ) {
 ...
 */
export const pixelToLocation = function( pixel, detail ) {
 ...
 */
export const pixelToTile = function( pixel ) {
	return {
		x: (pixel.x / 256),
		y: (pixel.y / 256)
	};
 ...
 */
export const tileToPixel = function( tile ) {
	return {
		x: (tile.x * 256),
		y: (tile.y * 256)
	};
 ...
 */
export const tileToQuadkey = function( tile, detail ) {
	var out = "";
 ...
 * @return {xycoord}         tile coordinates
 */
export const quadkeyToTile = function( quadkey ) {
	var tileX = 0
	  , tileY = 0
 ...
 */
export const tileToLocation = function( tile, detail ) {
 ...
 */
export const locationToQuadkey = function( location, detail ) {
 ...
 */
export const bbox = function( quadkey ) {
 ...
 */
export const inside = function( location, quadkey ) {
 ...
 */
export const origin = function( quadkey ) {
 ...
 */
export const children = function( quadkey ) {
 ...
 */
export const parent = function( quadkey ) {
